                    ...
                    {images?.map((val, i) => (
                        <div key={i} className="flex items-center gap-5 sm:gap-3 rounded-lg">
                            <div className='flex items-center'>
                                ...
                                >
                                    <img src={val.img} alt={val.location} className="max-w-full max-h-full sm:w-16 sm:h-16 rounded-lg filter drop-shadow-lg transition-all duration-300 cursor-pointer hover:scale-110 mr-10" />
                                </Button>
                            </div>
                        </div>
                    ))}
